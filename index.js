...
//Main backend part start openai te jegula deya ache
const upload = multer({
...
app.post('/get-prompt-result', async (req, res) => {
    ...
    // Check if prompt isn't present in the request tahole  400 code return korbe with error
    if (!prompt) {
    ...
    try {
        // Use the OpenAI to create a completion
